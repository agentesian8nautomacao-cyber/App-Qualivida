...
export interface Occurrence {
  ...
  /** Soft delete: removida/arquivada pelo admin; some só da lista do admin/síndico/porteiro. */
  deletedByAdmin?: boolean;
  /** Ocultada pelo morador na sua lista; continua visível para o admin. */
  deletedByResident?: boolean;
  /** Morador: true após visualizar; notificação some do sino. */
  isRead?: boolean;
}
