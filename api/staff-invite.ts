/**
 * API: GET /api/staff-invite?token=xxx
 * Retorna dados do convite (email, role, expiresAt) se o token for válido e não expirado/não usado.
 * Não exige autenticação; o token é o segredo.
 */
...
export default {
  async fetch(request: Request): Promise<Response> {
    ...
    try {
      ...
      console.error('[staff-invite]', msg);
      return Response.json(
