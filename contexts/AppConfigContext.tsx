...
/** Preço por área de reserva (chave = id da área). Usado no boleto do morador. */
export type AreaPrices = Record<string, number>;
...
export interface AppConfig {
  ...
  /** Valor (R$) por área de reserva para administração e exibição no boleto. */
    ...
    if (saved) {
      try {
        ...
        const merged: AppConfig = {
          ...
          areaPrices: { ...(defaultConfig.areaPrices || {}), ...(parsed?.areaPrices || {}) },
        };
        return merged;
      } catch {
