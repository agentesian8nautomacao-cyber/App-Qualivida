...
import { User, Lock, Eye, EyeOff, Sun, Moon, Building2, Briefcase, ChevronRight } from 'lucide-react';
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              ...
              >
                ...
                <span className="text-xs font-bold uppercase tracking-wider">ADM</span>
              </button>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              {/* Morador: cadastro + esqueci senha. Portaria/ADM: apenas esqueci senha (cadastro só por admin ou convite). */}
