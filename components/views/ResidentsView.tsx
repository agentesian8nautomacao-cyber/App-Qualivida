              ...
              {(resident.whatsapp) && (
                <div className="mt-6 pt-6 border-t border-white/5">
                  <button 
                    ...
                    className="w-full py-3 rounded-xl bg-green-500/10 text-green-500 hover:bg-green-500 hover:text-white transition-all text-[10px] font-black uppercase flex items-center justify-center gap-2"
                  >
