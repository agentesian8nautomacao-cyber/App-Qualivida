...
import { Search, UserPlus, MessageCircle, Trash2, Edit2, Briefcase, Upload, Link2 } from 'lucide-react';
          ...
          >
             ...
             <div className="mt-auto pt-6 border-t border-white/5">
                <button 
                  ...
                  className="w-full py-3 rounded-xl bg-green-500/10 text-green-500 hover:bg-green-500 hover:text-white transition-all flex items-center justify-center gap-2 disabled:opacity-30 disabled:cursor-not-allowed"
                >
